...
Route::redirect('/', '/my-finance');
Route::get('/my-finance', function () {
    return view('pages.landing-page', ['type_menu' => 'landing-page']);
});

// Dashboard
Route::get('/home', function () {
    return view('pages.home', ['type_menu' => 'home']);
});
Route::get('/sumber-dana', function () {
    return view('pages.sumber-dana', ['type_menu' => 'sumber-dana']);
});
